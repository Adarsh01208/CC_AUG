function checkPlagiarism() {
    ...
    if (text1.trim() === "" || text2.trim() === "") {
      result.innerHTML = "PLEASE, FILL OUT THE ABOVE BOXES !";
      return;
    }
    ...
    if (accuracy > 0) {
      result.innerHTML = "PLAGIARISM IS DETECTED! THE TEXT HAVE A SIMILARITY OF " + accuracy.toFixed(2) + "%.";
    } 
    else {
      result.innerHTML = "THERE IS NO PLAGIARISM. THE TEXT HAVE NO SIMILARITY.";
    }
  }
